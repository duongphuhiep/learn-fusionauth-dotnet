...
using FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission.Item;
...
using System;
namespace FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the FusionAuth.Sdk.api.entity.type.item.permission.item collection</summary>
        /// <param name="position">The Id of the permission. If not provided a secure random UUID will be generated.</param>
        ...
        public global::FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission.Item.WithPermissionItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("permissionId", position);
                return new global::FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission.Item.WithPermissionItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission.PermissionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission.PermissionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission.PermissionRequestBuilder WithUrl(string rawUrl)
        {
            return new global::FusionAuth.Sdk.Api.Entity.TypeNamespace.Item.Permission.PermissionRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
